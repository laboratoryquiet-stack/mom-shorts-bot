...
SUPPORT_CONTENT = [
    ...
    {
        "hook": "Can we talk about your career for a second? Not your kids' schedule. Yours.",
        "lines": [
            "The promotion you've been quietly hoping for, the skill you want to learn, the business idea you've shelved — none of that expired when you had kids.",
            "You're allowed to be ambitious and be a devoted mom. Nobody gets to make you choose.",
            "Put one hour toward your own goal this week. Not a to-do list item for the house — yours.",
        ],
        "theme": "career_confidence",
    },
    {
        "hook": "When's the last time you went to the doctor for you, not them?",
        "lines": [
            "You book every pediatrician appointment on time, and yours have been 'next month' for a year.",
            "Your health isn't the thing you get to after everyone else's needs are met. It's the thing that lets you meet them at all.",
            "Book the appointment this week. The one you've been putting off. Just one.",
        ],
        "theme": "self_care_permission",
    },
    {
        "hook": "You keep saying you'll rest when things calm down.",
        "lines": [
            "Things are not going to calm down. That's not pessimism, that's just what this season of life is.",
            "So rest isn't the reward at the end. It has to be part of the middle, or it never happens at all.",
            "Rest today. Not because you earned it — because you need it, and that's reason enough.",
        ],
        "theme": "exhaustion_relief",
    },
    {
        "hook": "I want you to picture your daughter, thirty years from now, exhausted, doubting herself, forgetting she matters too.",
        "lines": [
            "What would you want someone to tell her? Say that to yourself today. You deserve the same tenderness you'd give her.",
            "She's watching how you treat yourself, more than she's listening to what you tell her.",
            "Model a whole life for her — not just motherhood, all of it. Career, rest, joy, health. She's taking notes.",
        ],
        "theme": "identity_beyond_mom",
    },
    {
        "hook": "You don't need to earn stillness with exhaustion first.",
        "lines": [
            "You're allowed to sit down before you're completely depleted, not just when you finally collapse.",
            "Being 'productive' every waking minute isn't strength, it's just a habit you can unlearn.",
            "Try sitting still for ten minutes today and doing absolutely nothing. See how it feels.",
        ],
        "theme": "self_care_permission",
    },
    {
        "hook": "Somewhere along the way, 'selfish' became the word we use for taking care of ourselves.",
        "lines": [
            "It's not selfish to want quiet. It's not selfish to want a career that's yours. It's not selfish to want to feel like yourself again.",
            "A depleted version of you isn't more virtuous, it's just more depleted.",
            "Want things for yourself today. Out loud, if you can. It's allowed.",
        ],
        "theme": "identity_beyond_mom",
    },
    {
        "hook": "Your stress is trying to tell you something, and it's worth listening to.",
        "lines": [
            "Chronic stress isn't just 'part of being a mom' — it's your body asking for something to change.",
            "You don't have to white-knuckle through every hard season. You're allowed to actually address what's wearing you down.",
            "What's one source of your stress you could actually hand off or drop this week? Even one.",
        ],
        "theme": "exhaustion_relief",
    },
    {
        "hook": "You are allowed to want more than survival mode.",
        "lines": [
            "Getting everyone fed and to bed is not the ceiling of what your life gets to be.",
            "Somewhere past 'just getting through today' is a version of your life you actually love — career, health, joy, all of it.",
            "You don't have to build that later. You can start reaching for it now, in small pieces.",
        ],
        "theme": "career_confidence",
    },
    {
        "hook": "A community of women who understand this exact exhaustion is bigger than you think.",
        "lines": [
            "You are not the only one hiding in the pantry for two minutes of silence. Truly, not even close.",
            "Every mom scrolling past this right now has had the exact day you're having.",
            "You don't have to find your people alone. Comment below — I promise someone will relate.",
        ],
        "theme": "asking_for_help",
    },
]
